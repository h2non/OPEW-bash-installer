...
https://github.com/h2non/OPEW-bash-installer/blob/master/inc/installer.inc
...
function _license {
	...
	echo "You can see the all packages licenses at $OUTPUT/licenses/"
	...
	echo "You can read it at $OUTPUT/licenses"
	echo " "
...
function _doinstall {
	...
	tail -n +$skip $0 | `tar xvz -C $OUTPUT >> $FILES` &
...
function _postinstall {
	...
	echo " "
	echo "Take a look the README file located in $OUTPUT for getting started."
